from emg_ps.models import EmergencyCase
from django.urls import path

from .views import (DeleteEmergencyCase, DeleteEpidemic, DeleteMedicalEmergencyType, EditEmergencyCase, EditEpidemic, EditMedicalEmergencyType, MedicalEmergencyTypes, NotificationToContactPerson,
                    RegisterEpidemic, RegisterMedicalEmergencyType,
                    RegisterNewCase, ViewEmergencyCaseList, ViewEpidemicList)
